...
DiagnosticInfoXSLTDate,"2016-05-12"<xsl:text/>
...
MarkEventDate,"<xsl:value-of select="substring(ns2:MarkEventDate,1,10)"/>"<xsl:text/>
MarkEventDateTruncated,"<xsl:value-of select="ns2:MarkEventDate"/>"<xsl:text/>
